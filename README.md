...
So what is the future of HamClock?
In the immediate future, HamClock services will start to degrade, as backend dependencies go offline.

The front-end source code is here, but it will really take an effort to re-engineer and re-construct the infrastructure of HamClock to make it a viable ecosystem in the future.
