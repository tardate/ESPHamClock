...
| set_pane?Pane[123]=X,Y,Z... any set from:  VOACAP DE_Wx DX_Cluster DX_Wx Solar_Flux Planetary_K Moon|  NOAA_SpcWx Sunspot_N X-Ray SDO Solar_Wind DRAP Contests|  Live_Spots Bz_Bt On_The_Air ADIF Aurora DXPeditions | Set the specified data pane 1-3 content, if allowed.|
| set_pane?Pane0=X,Y,Z... any set from: DX_Cluster ADIF Contests POTA SOTA off| Set the specified plot data pane 0 content, if allowed.|
| set_panzoom?pan_x=X&pan;_y=Y&pan;_dx=dX&pan;_dy=dY&zoom;=Z  | Set map zoom and/or absolute or delta pan. Pan X [-330,330] Y [-165,165]. |
